...
public class ObjectFactory {
    ...
    private final static QName _Info_QNAME = new QName("http://cxfserver.itcast.cn/", "info");
    private final static QName _InfoResponse_QNAME = new QName("http://cxfserver.itcast.cn/", "infoResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfserver.itcast.cn/", name = "info")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxfserver.itcast.cn/", name = "infoResponse")
