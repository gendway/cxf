 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceService", targetNamespace = "http://impl.cxfserver.itcast.cn/", wsdlLocation = "http://localhost:9090/cxf/ws/weatherService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICESERVICE_QNAME = new QName("http://impl.cxfserver.itcast.cn/", "WeatherServiceService");
    ...
    public IWeatherService getWeatherServicePort() {
        return super.getPort(new QName("http://impl.cxfserver.itcast.cn/", "WeatherServicePort"), IWeatherService.class);
    }
    ...
    public IWeatherService getWeatherServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.cxfserver.itcast.cn/", "WeatherServicePort"), IWeatherService.class, features);
    }
